...
Date: 1/14/24
Description: Contains class definition and methods to read, filter, and format data from data file. Also contains primary "generateGraph" function.
"""
