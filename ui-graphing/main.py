...
if __name__ == '__main__':
    ...
    class_menu = gen_dropdown(root, side_frame, "No Course Selected", courses)
    ...
    # Submit button
    submit_button = gen_button(side_frame, "Submit", lambda: send_obj(year_menu, class_menu, user_input, check_instructors))
